  ...
  private
    ...
    def admin_loggedin?   
      if session[:admin].nil?
        flash[:notice] = "You need to login as as Admin to continue"
    ...
    def store_params
      params.require(:store).permit(:name, :category, :description, :price, :ingredients, :made_without, :packaging, :certifications,:product_image)
    end
end
